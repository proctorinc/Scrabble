  ...
  const Wrapper: FC<WrapperProps> = ({ children }) => {
    if (isCurrentPlayer) {
      return (
        <div className="flex w-full justify-end gap-1 items-center">
          <div className="flex gap-1 bg-gray-200 shadow-inner rounded-lg px-3 py-2 w-fit items-center">
            <span className="text-xs">{children}</span>
          </div>
          <span className="flex w-8 h-8 rounded-lg items-center justify-center text-white font-semibold bg-gradient-to-tr from-blue-400 to-blue-300 shadow-inner">
            P1
          </span>
        </div>
      );
    ...
    return (
      <div className="flex w-full gap-1 items-center">
        <span className="flex w-8 h-8 rounded-lg items-center justify-center text-white font-semibold bg-gradient-to-tr from-red-400 to-red-300 shadow-inner">
          P2
        </span>
        <div className="flex gap-1 bg-gray-200 shadow-inner rounded-lg px-3 py-2 w-fit items-center">
          <span className="text-xs">{children}</span>
